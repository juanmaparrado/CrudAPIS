...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-03-2023 a las 12:26:01
...
CREATE TABLE `tabla_datos` (
  `id` int NOT NULL,
  `country` varchar(255) COLLATE utf8mb4_spanish_ci NOT NULL,
  `population1970` bigint NOT NULL,
  `population2022` bigint NOT NULL,
  `area` int NOT NULL
